...
@Ignore
public class ZhipuAIHandlerTest {
    private static final Logger log = LoggerFactory.getLogger(ZhipuAIHandlerTest.class);
    private static final String handlerName = "zhipu";
    private static final String embedModel = "embedding-3";
    private static final String chatModel = "GLM-4-0520";

    static {
        JsonUtils.registerHandler("default", new FastJsonHandler());
        AIUtils.registerHandler(handlerName, new AbstractZhipuAIHandler() {
            @Override
