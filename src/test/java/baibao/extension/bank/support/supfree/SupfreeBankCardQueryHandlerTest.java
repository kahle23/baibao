...
public class SupfreeBankCardQueryHandlerTest {
    ...
    public void test1() {
        ...
        BankCard bankCard = ActionUtils.execute(cardQuery, BANK_CARD_NAME, BankCard.class);
        log.info("{}", JSON.toJSONString(bankCard, true));

        cardQuery = new BankCardQuery("6230960288002899254");
        BankCard bankCard1 = ActionUtils.execute(cardQuery, BANK_CARD_NAME, BankCard.class);
        log.info("{}", JSON.toJSONString(bankCard1, true));

        cardQuery = new BankCardQuery("6217994000264606028");
        BankCard bankCard2 = ActionUtils.execute(cardQuery, BANK_CARD_NAME, BankCard.class);
        log.info("{}", JSON.toJSONString(bankCard2, true));

        cardQuery = new BankCardQuery("6230666046001759766");
        BankCard bankCard3 = ActionUtils.execute(cardQuery, BANK_CARD_NAME, BankCard.class);
